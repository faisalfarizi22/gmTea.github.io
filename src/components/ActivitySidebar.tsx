                ...
                <motion.button 
                  ...
                  className={`px-4 py-1.5 rounded-full text-sm flex items-center space-x-1.5 whitespace-nowrap border ${
                    activeFilter === 'username' 
                      ? 'border-blue-200 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-900/20' 
                      : 'border-transparent bg-gray-50 dark:bg-gray-800/30'
                  } transition-all`}
                  initial={activeFilter === 'username' ? 'active' : 'inactive'}
                  animate={activeFilter === 'username' ? 'active' : 'inactive'}
                  variants={filterVariants}
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                  <span className={activeFilter === 'username' ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}>Usernames</span>
                </motion.button>
                ...
                <motion.button 
                  ...
                  className={`px-4 py-1.5 rounded-full text-sm flex items-center space-x-1.5 whitespace-nowrap border ${
                    activeFilter === 'referral' 
                      ? 'border-pink-200 dark:border-pink-500/30 bg-pink-50 dark:bg-pink-900/20' 
                      : 'border-transparent bg-gray-50 dark:bg-gray-800/30'
                  } transition-all`}
                  initial={activeFilter === 'referral' ? 'active' : 'inactive'}
                  animate={activeFilter === 'referral' ? 'active' : 'inactive'}
                  variants={filterVariants}
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <span className="w-2 h-2 rounded-full bg-pink-500"></span>
                  <span className={activeFilter === 'referral' ? 'text-pink-600 dark:text-pink-400' : 'text-gray-600 dark:text-gray-400'}>Referrals</span>
                </motion.button>
                                  ...
                                  <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                      ...
                                      <div className="flex items-center">
                                        <FaClock className="text-gray-400 dark:text-gray-500 h-3 w-3 mr-1" />
